...
<html>
<head>
    <title>Daftar Seni Tunggal</title>
    <style>
...
<body>
    <div class="form-container">
        ...
        <form action="{{ route('senitunggal.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="tglLahirPeserta">Tanggal Lahir</label>
                <input type="date" id="tglLahirPeserta" name="tglLahirPeserta" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="kategori" name="kategori" value="Seni Tunggal" readonly>
            </div>
