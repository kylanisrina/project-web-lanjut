...
<body>
    <div class="form-container">
        ...
        <form action="{{ route('seniganda.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="tglLahirKetua">Tanggal Lahir Ketua</label>
            ...
            <div class="form-group">
                <label for="tglLahirAnggota1">Tanggal Lahir Anggota 1</label>
            ...
            <div class="form-group">
                ...
                <input type="text" id="kategori" name="kategori" value="Seni Ganda" readonly>
            </div>
